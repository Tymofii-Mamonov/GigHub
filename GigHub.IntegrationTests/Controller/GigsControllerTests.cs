...
namespace GigHub.IntegrationTests.Controller
{
    [TestFixture]
    public class GigsControllerTests
    {
        ...
        [Test, Isolated]
        public void Update_WhenCalled_ShouldUpdateTheCurrentGig()
        {
            // Arrange
            var user = _context.Users.First();
            _controller.MockCurrentUser(user.Id, user.Name);
            ...
            {
                Id = gig.Id,
                Date = DateTime.Today.AddMonths(1).ToString("d MMM yyyy", new CultureInfo("en-US")),
                Time = "20:00",
                Venue = "Venue",
                Genre = 2
            });
