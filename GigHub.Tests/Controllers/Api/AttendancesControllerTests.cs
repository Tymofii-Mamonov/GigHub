...
namespace GigHub.Tests.Controllers.Api
{
    ...
    public class AttendancesControllerTests
    {
        ...
        [TestMethod]
        public void Attend_ValidRequest_OkResult()
        {
            var result = _controller.Attend(new AttendanceDto {GigId = 1});
        ...
        [TestMethod]
        public void RemoveAttendance_AttendanceNotFound_ShouldReturnNotFound()
        {
        ...
        [TestMethod]
        public void RemoveAttendance_ValidRequest_ShouldReturnOkResult()
        {
            var attendance = new Attendance();
            _mockRepository.Setup(r => r.GetAttendance(_userId, 1)).Returns(attendance);
        ...
        [TestMethod]
        public void RemoveAttendance_ValidRequest_ShouldReturnIdOfDeletedAttendance()
        {
            var attendance = new Attendance();
            _mockRepository.Setup(r => r.GetAttendance(_userId, 1)).Returns(attendance);
