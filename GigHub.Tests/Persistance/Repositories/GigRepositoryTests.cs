...
namespace GigHub.Tests.Persistance.Repositories
{
    ...
    public class GigRepositoryTests
    {
        ...
        [TestMethod]
        public void GetGigsUserAttending_UserIsNotAttendingThisGig_ShoulNotBeReturned()
        {
        ...
        [TestMethod]
        public void GetGigsUserAttending_GigsInFutureAndAttendeeIsCurrentUser_ShouldReturnGig()
        {
            var gig = new Gig {DateTime = DateTime.Now.AddDays(1)};
